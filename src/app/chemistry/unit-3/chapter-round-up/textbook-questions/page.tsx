  ...
  return (
    <div className="p-6">
      ...
      <p className="mb-5 text-blue-600">
        ...
        of the atom? (Cantab Exercise Question) OR <br />
        Summarize Rutherford&apos;s model of an atom and explain how he
        developed this model based on the results of his famous gold-foil
        experiment. OR <br />
        Discuss Rutherford gold metal foil experiment in the light of structure
        of atom OR <br />
        Can you describe the experiment and result deduced by Rutherford for
        explaining atomic structure? OR <br />
        Describe the contribution that Rutherford made to the development of the
        atomic theory. OR <br />
      ...
      <p className="mb-5 text-blue-600">
        ...
        Question) OR <br />
        State the postulates which Bohr suggested to overcome the shortcomings
        of the Rutherford&apos;s atomic model. OR <br />
        Explain how Bohr&apos;s atomic theory differed from Rutherford&apos;s
        atomic theory? OR <br />
        How did Bohr proved that an atom must exist? OR <br />
      ...
      <p className="mb-5 text-blue-600">
        ...
        <br />
        (iii) What is the difference between the mass number and the atomic mass
        of an element? <br />
        Write the names and symbols for the elements with the following atomic
        numbers: <br />
        a. 1 <br />
        b. 11 <br />
        c. 19 <br />
...
h. 2
     ...
     <p className="text-blue-600">   Q22: Give comparison of ordinary water and heavy water.</p>
        ...
        <br />
        Can you complete it? Natural abundance of isotopes of carbon is as
        follows.
        <br />
      ...
      Uranium has three isotopes with mass number 234, 235 and 238
        ...
        abundance of Uranium isotopes is as follows. 92 ^ 214 U = 0.009% , 92 ^
        235 U = 0.72% , 92 ^ 235 U = 99.27% Fill in the blanks? 134 U has 92
...
Calculate relative atomic mass of carbon. 
 ...
 <br />
      ...
      <p className="mb-5 text-blue-600">
        ...
        Zn. None of these isotopes has the atomic mass of 65.41 listed for zinc
        on the periodic table. Explain. <br />
        (ii) Two isotopes of gallium are naturally occurring, with Gaat 60.11%
        (68.93 amu) and Ga at 39.89% (70.92 amu). Calculate the atomic mass for
        gallium using the weighted average mass method. <br />
        (iii) Two isotopes of rubidium occur naturally, with Rbat 27.83% (84.91
        amu) and Rb at 27.83% (86.91 amu). Calculate the atomic mass for
        rubidium using the weighted average mass method. <br />
      ...
      <p className="mb-5">
        Q30: What is Carbon dating? OR <br />
        Explain how, through carbon dating scientists determine the age of
        ancient artifacts or human remains? Q31: Write a note on how radio
        isotopes use in medical imaging technology along applications of
        different isotopes?
      </p>

      <p className="mb-5">
        Q32: Discuss some differences between chemical reaction and nuclear
        reactions?
      </p>
    </div>
  );
