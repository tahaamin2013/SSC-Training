export default function TimingOfTransactionsPage() {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow mt-8">
      <h1 className="text-2xl font-bold mb-4 text-gray-800">9 TIMING OF TRANSACTIONS</h1>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">FA1: RECORDING FINANCIAL TRANSACTIONS</h2>
      <div className="mb-4">
        <span className="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-semibold mb-2">ACTIVITY 3</span>
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-700 pl-4">
          <li>
            State why the manager will need to ensure careful records are maintained of the receipts and payments associated with this project.
          </li>
          <li>
            Explain why the manager will need to set up a system of authorisation and control for expenditure.
          </li>
          <li>
            Explain why timing is important when dealing with financial transactions under such a project.
          </li>
        </ol>
