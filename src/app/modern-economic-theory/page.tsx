...
const data: Section[] = [
    { id: "1", link: "/modern-economic-theory/unit-1", unit: "1", title: "NATURE OF ECONOMICS: DEFINITIONS " },
    { id: "2", link: "/modern-economic-theory/unit-2", unit: "2", title: "NATURE OF ECONOMICS: SCOPE AND METHOD " },
];
    ...
    return (
        <Link href={section.link} onClick={handleClick} className="group relative overflow-hidden rounded-2xl  shadow-lg border-white/40 border shadow-white/5 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="relative z-10 p-6 pt-3">
                ...
                <h2 className="mb-2 capitalize text-md font-bold  text-zinc-200 transition-colors duration-300 group-hover:text-white">
                    {section.title}
                </h2>
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <h1 className="mb-12 text-center text-5xl font-extrabold leading-tight tracking-tight text-transparent text-white">
                    Dive into the World of Economics
                </h1>
                <div
